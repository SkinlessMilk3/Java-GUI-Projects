...
public class Main {
    ...
    public static void main(String[] args) {
        Window wnd = new JFrame();//new Window(null, null);

        wnd.setBounds(50, 100, 500, 500);
        wnd.setLocation(50,50);

        wnd.setVisible(true);

        wnd.addComponentListener(new ComponentEventListener(){
            @Override
 ...
 *
 * To receive a KeyPressed event the listener should be a KeyPressedListener or of a different name. Just need
